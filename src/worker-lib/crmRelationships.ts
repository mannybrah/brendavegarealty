...
import { normalizeEmailInputs, normalizePhoneInputs, PhoneInput, EmailInput } from "../lib/crm/contactsInput";
import type { EmailRow, PhoneRow, RelationshipFull, RelationshipRow } from "../lib/crm/types";
...
async function loadFull(env: Env, id: string): Promise<RelationshipFull | null> {
  ...
  return { ...rel, phones: p.results ?? [], emails: e.results ?? [] };
}
