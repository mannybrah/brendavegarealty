...
describe("rowsToImportContacts", () => {
  ...
  test("stage mapping table covers all documented values", () => {
    ...
    const cases: [string, string][] = [
      ...
      ["nurture@x.com,Nurture", "nurture"],
      ["attempted@x.com,Attempted Contact", "attempted_contact"],
      ["appt@x.com,Appointment Set", "appointment_set"],
      ["uc@x.com,Under Contract", "under_contract"],
      ["showing@x.com,Showing Homes", "active"],
  ...
  test("stage mapping covers Brenda's real brokerage export vocabulary", () => {
    ...
    const cases: [string, string][] = [
      ...
      ["e@x.com,Lead - Attempted to contact", "attempted_contact"],
